...
# http://127.0.0.1:5000/watch-information/table full view/Fossil
@app.route('/watch-information/table full view/Fossil', methods=['GET'])
def home():
    results = session.query(WatchInformation).all()
